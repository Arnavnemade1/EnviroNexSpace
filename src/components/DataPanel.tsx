...
import { Wind, Thermometer, Eye, Heart, Activity, TrendingUp, TrendingDown, Play, Pause, RotateCcw, Chrome as Home, ChartBar as BarChart3, Atom } from 'lucide-react';
...
export const DataPanel = ({
  ...
  const handleHealthNavigation = () => {
    if (cityName && airQuality && cityLat !== undefined && cityLng !== undefined) {
      navigate('/health', {
        state: {
          cityName,
          cityLat,
